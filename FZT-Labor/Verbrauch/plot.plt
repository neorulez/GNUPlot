...
set style line 1 lt 1 linecolor rgb 'blue' lw 2		#blue
set style line 2 lt 1 linecolor rgb 'black' lw 2 	#orange
...
#plot
plot "werte.dat" using 1:2 title "without load" with lines ls 4 #points pt 3 lt 1
replot "werte.dat" using 1:3 title "with load" with lines ls 5 #points pt 2 lt 7
